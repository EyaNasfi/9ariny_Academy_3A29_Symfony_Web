...
<?php
    ...
    $listelivraison=$livraisonL->Afficherlivraison(); 
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Listes Livraisons</h4>
          ...
          ?>
                ...
                <!------Rec---->
                  <div>
                  <a class="btn btn-primary" href="Ajouterlivraison.php" role="button">Nouveau Livraisons</a>
                  <a class="btn btn-primary" href="pdf1.php" role="button">PDF</a>
                </div>
                <td></td>
                ...
                <p>.</p>
                  ...
                  <table id="tablelivraison" class="table">
		   <thead>
			<tr>
				<th>Idlivreure</th> 
        ...
        <th>NomLivreure</th>
        <th>TelLivreure</th>
        <th>VehiculeLivreure</th>
        <th>StatutLivreure</th>
				<th>Datelivreure</th>
				<th>Modifier</th>
				<th>Supprimer</th>
			</tr>
			...
			?>
			<tr>
                <td><?php echo $livraison['Idlivreure']; ?></td>
				        <td><?php echo $livraison['Adresselivreure']; ?></td>
                <td><?php echo $livraison['Couttotal']; ?></td>
                <td><?php echo $livraison['NomLivreure']; ?></td>
                <td><?php echo $livraison['TelLivreure']; ?></td>
                <td><?php echo $livraison['VehiculeLivreure']; ?></td>
                <td><?php echo $livraison['StatutLivreure']; ?></td>
                <td><?php echo $livraison['Datelivreure']; ?></td>
				<td>
					<form method="GET" action="Modifierlivraison.php">
						<input type="submit"  class="btn btn-primary btn-sm" name="Modifier" value="Modifier">
						<input type="hidden"  value=<?php echo $livraison['Idlivreure']; ?>  name="Idlivreure">  
					</form>
				</td>
				<td>
					<a  class="btn btn-danger btn-sm"   href="Supprimerlivraison.php?Idlivreure=<?php echo $livraison['Idlivreure']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
