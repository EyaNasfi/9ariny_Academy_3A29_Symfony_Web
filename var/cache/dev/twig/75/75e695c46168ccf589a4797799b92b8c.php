...
class __TwigTemplate_9cbab47856a77b8a901330c5de95fa4d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["Cours"]) || array_key_exists("Cours", $context) ? $context["Cours"] : (function () { throw new RuntimeError('Variable "Cours" does not exist.', 604, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["cours"]) {
            // line 605
            echo "    <tr>
        <th scope=\"row\">";
            // line 606
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["cours"], "idcour", [], "any", false, false, false, 606), "html", null, true);
            echo "</th>
        <td>";
            // line 607
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["cours"], "nomCours", [], "any", false, false, false, 607), "html", null, true);
            echo "</td>
        <td>
           ";
            // line 609
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["cours"], "descriptionCours", [], "any", false, false, false, 609), "html", null, true);
            echo "
        </td>
        <td>";
            // line 611
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["cours"], "idformation", [], "any", false, false, false, 611), "html", null, true);
            echo "</td>
    </tr>
";
        }
...
";
    ...
    {
        return array (  739 => 614,  730 => 611,  725 => 609,  720 => 607,  716 => 606,  713 => 605,  709 => 604,  696 => 593,  686 => 592,  667 => 590,  649 => 618,  647 => 592,  644 => 591,  642 => 590,  572 => 523,  555 => 509,  45 => 1,);
    }
