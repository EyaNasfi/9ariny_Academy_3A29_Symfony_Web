 ...
 */
class getCourFormationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CourFormationRepository' shared autowired service.
     *
     * @return \App\Repository\CourFormationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CourFormationRepository.php';

        return $container->privates['App\\Repository\\CourFormationRepository'] = new \App\Repository\CourFormationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
