...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'flasher.notyf' => 'getFlasher_NotyfService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'php-flasher'.\DIRECTORY_SEPARATOR.'flasher-notyf'.\DIRECTORY_SEPARATOR.'NotyfFactory.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zGxvRNVtPx', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YCQcW4iqxl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Y3kUuPkB+H', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getFlasherService()
    {
        ...
        $b = new \Flasher\Prime\Response\Resource\ResourceManager(new \Flasher\Prime\Config\Config(['presets' => ['created' => ['type' => 'success', 'message' => 'The resource was created', 'options' => []], 'updated' => ['type' => 'success', 'message' => 'The resource was updated', 'options' => []], 'saved' => ['type' => 'success', 'message' => 'The resource was saved', 'options' => []], 'deleted' => ['type' => 'success', 'message' => 'The resource was deleted', 'options' => []]], 'default' => 'flasher', 'root_script' => ['cdn' => 'https://cdn.jsdelivr.net/npm/@flasher/flasher@1.3.2/dist/flasher.min.js', 'local' => '/vendor/flasher/flasher.min.js'], 'scripts' => [], 'styles' => ['cdn' => [0 => 'https://cdn.jsdelivr.net/npm/@flasher/flasher@1.3.2/dist/flasher.min.css'], 'local' => [0 => '/vendor/flasher/flasher.min.css']], 'options' => [], 'use_cdn' => true, 'auto_translate' => true, 'auto_render' => true, 'filter_criteria' => [], 'themes' => [], 'flash_bag' => ['enabled' => true, 'mapping' => ['success' => [0 => 'success'], 'error' => [0 => 'error', 1 => 'danger'], 'warning' => [0 => 'warning', 1 => 'alarm'], 'info' => [0 => 'info', 1 => 'notice', 2 => 'alert']]]]), new \Flasher\Symfony\Template\TwigTemplateEngine($a));
        $b->addScripts('notyf', ['cdn' => [0 => 'https://cdn.jsdelivr.net/npm/@flasher/flasher-notyf@1.3.2/dist/flasher-notyf.min.js'], 'local' => [0 => '/vendor/flasher/flasher-notyf.min.js']]);
        $b->addStyles('notyf', ['cdn' => [0 => 'https://cdn.jsdelivr.net/npm/@flasher/flasher-notyf@1.3.2/dist/flasher-notyf.min.css'], 'local' => [0 => '/vendor/flasher/flasher-notyf.min.css']]);
        $b->addOptions('notyf', []);
        ...
        $instance->addFactory('notyf', ($this->services['flasher.notyf'] ?? $this->getFlasher_NotyfService()));
    ...
    /**
     * Gets the public 'flasher.notyf' shared service.
     *
     * @return \Flasher\Notyf\Prime\NotyfFactory
     */
    protected function getFlasher_NotyfService()
    {
        return $this->services['flasher.notyf'] = new \Flasher\Notyf\Prime\NotyfFactory(($this->privates['flasher.storage_manager'] ?? $this->getFlasher_StorageManagerService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IIOWLf9gni', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('tsx39gRf-R', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2VRUvLaIvr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yHKeglYIew', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DMyfTb-tgx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GqtQlOZGD9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QEIaFwCg8z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'FlasherNotyfSymfonyBundle' => 'Flasher\\Notyf\\Symfony\\FlasherNotyfSymfonyBundle',
            ...
            'kernel.bundles_metadata' => [
                ...
                'FlasherNotyfSymfonyBundle' => [
                    'path' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'php-flasher'.\DIRECTORY_SEPARATOR.'flasher-notyf-symfony'),
            ...
            'app.autoload' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'autoload.php'),
