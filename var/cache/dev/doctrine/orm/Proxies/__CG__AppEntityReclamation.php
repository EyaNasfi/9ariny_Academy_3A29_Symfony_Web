...
class Reclamation extends \App\Entity\Reclamation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Reclamation' . "\0" . 'idrec', '' . "\0" . 'App\\Entity\\Reclamation' . "\0" . 'titre', '' . "\0" . 'App\\Entity\\Reclamation' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Reclamation' . "\0" . 'iduser'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIduser(?\App\Entity\User $iduser): static
    {
