...
{   
    ...
    public function AddFormation(Request $request, EntityManagerInterface $entityManager,FormationRepository $repFormation,SerializerInterface $serializer): Response
    {
        $formation = new Formation();
        $form = $this->createForm(FormationType::class, $formation);
        $form->handleRequest($request);
        $formationsParCategorie = $repFormation->countFormationsByCategory();
        ...
        return $this->render('Front/AjouterFormation.html.twig', [
            'form' => $form->createView() ,'jsonData' => $jsonData
        ]);    }
        #[Route('/Formation', name: 'list_Formation')]
        public function AffichageFormation(FormationRepository $repFormation,SerializerInterface $serializer)
        {
            $formationsParCategorie = $repFormation->countFormationsByCategory();
    ...
    // Afficher le template avec les données JSON
            ...
            return $this->render("Front/backtemplate.html.twig", ["Formation" => $repFormation->findAll(),'jsonData' => $jsonData]);
        }
