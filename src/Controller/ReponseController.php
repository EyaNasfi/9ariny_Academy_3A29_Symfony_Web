   ...
   // $reclamation->setIduser(2);
    ...
    $form->handleRequest($req); //traitement de requete  , 
        ...
        if ($form->isSubmitted() && $form->isValid()) { //kn form valide 
           ...
           /* $mailin = new Mailin('eyanasfi1@gmail.com', 'vYfZH1dyIsURPcCj');
                                        $mailin->
                                        addTo('eyanasfi1@gmail.com', 'eya nasfi')->
                                        setFrom('eyanasfi1@gmail.com', 'eya nasfi')->
                                        setReplyTo('eyanasfi1@gmail.com','eya nasfi')->
                                        setSubject('Entrer l')->
                                        setText('Bonjour')->
