...
<?php
    ...
    $listearticle=$articleC2->AfficherArticle2(); 
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Listes Articles</h4>
          ...
          ?>
                ...
                <!------Rec---->
                  <div>
                  <a class="btn btn-primary" href="AjouterArticle2.php" role="button">Nouveau Article</a>
                </div>
                <td></td>
                ...
                <p>.</p>
                  ...
                  <table id="tableReclamation" class="table">
		   <thead>
			<tr>
				<th>idA</th> 
				<th>NomA</th>	
			...
			<?php
				...
				foreach($listearticle as $article2){
			?>
			<tr>
                <td><?php echo $article2['idA']; ?></td>
				        <td><?php echo $article2['nomA']; ?></td>
			  	      <td><?php echo $article2['quantite']; ?></td>
                <td><?php echo $article2['prix']; ?></td>
                <td><?php echo $article2['modeleA']; ?></td>
				<td>
					<form method="GET" action="ModifierArticle2.php">
						<input type="submit"  class="btn btn-primary btn-sm" name="Modifier" value="Modifier">
						<input type="hidden"  value=<?php echo $article2['idA']; ?>  name="idA">  
					</form>
				</td>
				<td>
					<a  class="btn btn-danger btn-sm"   href="SupprimerArticle2.php?idA=<?php echo $article2['idA']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
