        ...
        <div class="content-wrapper">
          ...
          ?>
		   ...
		   <thead>
			...
			?>
			<tr>
                <td><?php echo $article['idA']; ?></td>
				        <td><?php echo $article['nomA']; ?></td>
				...
				<td>
					<form method="GET" action="ModifierArticle.php">
						...
						<input type="hidden"  value=<?php echo $article['idA']; ?>  name="idA">  
					</form>
				</td>
				<td>
					<a  class="btn btn-danger btn-sm"   href="SupprimerArticle.php?idA=<?php echo $article['idA']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
