      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Modifier Reclamation</h4>
        ...
        <form method="post" onchange ="Verif();" >
            ...
            <label class="col-sm-3 col-form-label "  >adresse</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="adresse" id="adresse" value="<?php echo $reclamation['adresse']; ?>">
                    <a id="test2"></a>
                </div>
            </div>
            ...
            <!---------------------------------------------telephone---------------------------------------------->
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label " >Telephone</label>
                      <div class="col-sm-6">
                    <input type="number" class="form-control" name="telephone"  id="telephone" value="<?php echo $reclamation['telephone']; ?>">
                    <a id="test3"></a>
                      </div>
                </div>
            <!---------------------------------------------message---------------------------------------------->
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                <textarea class="input-group mb-3" name="message" id="message" cols="10" rows="10" value="<?php echo $reclamation['message']; ?>"></textarea>
