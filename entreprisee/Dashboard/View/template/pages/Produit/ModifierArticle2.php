<?php
    include_once '../../../../Model/article2.php';
    include_once '../../../../Controller/articleC2.php';
    ...
    if (        
        ...
        if (            
            ...
            $articleC2->ModifierArticle2($article2, $_GET["idA"]);
            header('Location:AfficherArticle2.php?mess=Article Modifé avec succés');
        }
        else
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">        
        ...
        <?php
            if (isset($_GET['idA'])){
                $article = $articleC2->Recupererarticle2($_GET['idA']);
    ...
    <form method="post"  >
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="nomA" id="nomA" value="<?php echo $article2['nomA'];?>">
            ...
            <label class="col-sm-3 col-form-label "  >Quantite</label>
                <div class="col-sm-6">
                    <input type="number" class="form-control" name="quantite" id="quantite" value="<?php echo $article2['quantite']; ?>">
            ...
            <!---------------------------------------------prix---------------------------------------------->
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label ">Prix</label>
                      <div class="col-sm-6">
                    <input type="number" class="form-control" name="prix"  id="prix" value="<?php echo $article2['prix']; ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="modeleA" id="modeleA" value="<?php echo $article2['modeleA'];?>">
             ...
             <div class="col-sm-3 d-grid">
                 <a class="btn btn-primary" href="AfficherArticle2.php" role="button">Retour</a>
             </div>
          </div>
            </table>
        </form>
