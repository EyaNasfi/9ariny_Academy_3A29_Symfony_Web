  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">        
        ...
        <?php
            if (isset($_GET['idA'])){
                $article = $articleC->Recupererarticle($_GET['idA']);
    ...
    <form method="post"  >
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="nomA" id="nomA" value="<?php echo $article['nomA'];?>">
            ...
            <label class="col-sm-3 col-form-label "  >Quantite</label>
                <div class="col-sm-6">
                    <input type="number" class="form-control" name="quantite" id="quantite" value="<?php echo $article['quantite']; ?>">
            ...
            <!---------------------------------------------prix---------------------------------------------->
                <div class="row mb-3">
                    <label class="col-sm-3 col-form-label ">Prix</label>
                      <div class="col-sm-6">
                    <input type="number" class="form-control" name="prix"  id="prix" value="<?php echo $article['prix']; ?>">
